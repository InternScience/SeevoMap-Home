...
const DOC_PATHS = [
  ...
  {
    title: "Examples",
    desc: "Two public examples on one page: Parameter Golf for competition-style metric loops and Math_000 for benchmark-first scoring.",
    to: "/docs/examples",
    ...
    >
      ...
      <section className="surface-card section-tone-stone rounded-3xl p-6 sm:p-8">
        ...
        <p className="text-sm text-text-secondary leading-relaxed mb-4">
          ...
          the specific environment you actually use, or open <code>Examples</code>{" "}
